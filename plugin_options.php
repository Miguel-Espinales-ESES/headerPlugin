...
class plugin_options {
  ...
  */
  ...
  function register_plugin_settings() {
      register_setting( 'wpHeader-settings-group', 'wpHeader-plugin' );
  }
  ...
  */
  ...
  function render_plugin_options_page() {
    ...
    </script> <div id="wpHeader-options"></div>';
  }

  function add_type_attribute_admin($tag, $handle, $src)
  {
      // change the script tag by adding type="module" and return it.
      if ($handle  === 'wpHeader-plugin-options-dev') {
  ...
  function enqueue_admin_scripts($hook) {
    ...
    if( $hook === $this->plugin_options_page ) {
      ...
      $handle = 'wpHeader-plugin-options-';
